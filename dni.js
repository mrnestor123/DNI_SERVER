...
async function getToken() {
    ...
    // Reutilizamos el token mientras no haya expirado (margen de 60s)
    ...
    if (res?.access_token) {
        const expiresIn = (res.expires_in || 3600) - 60; // margen de 60s
        tokenCache = { value: res.access_token, expiresAt: Date.now() + expiresIn * 1000 };
    }
